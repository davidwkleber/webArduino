...
rectHeight = 30;
  ...
  myPort = new Serial(this, Serial.list()[PortNum], buad);
  ...
  values[0] = 0;
  min[0] = 0;
  max[0] = 16368;  // 8-bit (0-255) example
  valColor[0] = color(255, 0, 0); // red
 
  values[1] = 0;    
  min[1] = 0;
  max[1] = 3069; // 10-bit (0-1023) example
  valColor[1] = color(0, 255, 0); // green
 
  values[2] = 0;
  min[2] = 0;
  max[2] = 11253;    // 1-bit (0-1) example, e.g. a digital switch
